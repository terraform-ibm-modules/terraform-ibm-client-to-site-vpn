...
* [Deployable Architectures](./solutions)
    * <a href="./solutions/fully-configurable">Cloud automation for Client to Site VPN (Fully configurable)</a>
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_sm_crn_parser"></a> [sm\_crn\_parser](#module\_sm\_crn\_parser) | terraform-ibm-modules/common-utilities/ibm//modules/crn-parser | 1.4.2 |
