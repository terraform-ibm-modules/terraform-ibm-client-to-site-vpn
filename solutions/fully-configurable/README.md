...
| <a name="input_enable_certificate_auth"></a> [enable\_certificate\_auth](#input\_enable\_certificate\_auth) | Set to true to enable client certificate authentication for this VPN server. For more information, see https://cloud.ibm.com/docs/vpc?topic=vpc-vpn-client-environment-setup | `bool` | `false` | no |
